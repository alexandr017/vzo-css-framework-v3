var slideShow = (function () {
    return function (data) {
        ...
        var init = function (data) {
            ...
            for (let i = 0; i < slidesCount; i++) {
                if(arr[i]){
                    ...
                    if(elementName == 'compare-slide'){
                        reviewItem = true;
                    }else {
                        reviewItem = false;
                    }
                    if(reviewItem == true){
                        slideContent += '<div class="jsSlideCompare" style="width:' + slideItemWidth + '%;min-width:' + slideItemWidth + '%;height: '+elHeight+'px;"> <div class="jsSlideItem '+itemClases+'" >' + arr[i].innerHTML + '</div></div>';
                    }else{
        ...
        var slideLeft = function (e) {
            ...
            setTimeout(function(){
                for (let i = 0; i < slidesCount; i++) {
                    ...
                    if(reviewItem == true){
                        slideContentAll += '<div class="jsSlideCompare" style="width:' + slideItemWidth + '%;min-width:' + slideItemWidth + '%;height: '+elHeight+'px;"> <div class="jsSlideItem '+itemClases+'" >' + arr[i].innerHTML + '</div></div>';
                    }else{
        ...
        var btnsClickAndDataset = function (dataset) {
            ...
            var border = document.getElementsByClassName('jsSlideItem');

            if(border.length < 10){
                for (let i=0; i<=border.length;i++){
                    border[1].style.borderLeft = '1px solid #ebebeb';
                    border[2].style.borderLeft = '1px solid #ebebeb';
                }
            }
        }
...
if(document.getElementsByClassName('compare-slide').length>0){
    slideShow({
        element:'.compare-slide',
        slidesToShow:3,
        slidesToScroll:1,
        circleScroll:true,
        height:'500',
