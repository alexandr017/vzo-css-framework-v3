...
@font-face {
    ...
    url('/modules/fonts/futura-pt/FuturaPT-Medium.eot?#iefix') format('embedded-opentype'),
    url('/modules/fonts/futura-pt/FuturaPT-Medium.woff') format('woff'),
    url('/modules/fonts/futura-pt/FuturaPT-Medium.ttf') format('truetype');
    font-weight: 500;
    font-style: normal;
}
...
@font-face {
    ...
    url('/modules/fonts/futura-pt/FuturaPT-MediumObl.eot?#iefix') format('embedded-opentype'),
    url('/modules/fonts/futura-pt/FuturaPT-MediumObl.woff') format('woff'),
    url('/modules/fonts/futura-pt/FuturaPT-MediumObl.ttf') format('truetype');
    font-weight: 500;
    font-style: italic;
}
/*
...
@font-face {
    font-display: swap;
    font-family: 'Futura PT';
    src: url('/modules/fonts/futura-pt/FuturaPT-Bold.eot');
    src: local('Futura PT Bold'), local('FuturaPT-Bold'),
    url('/modules/fonts/futura-pt/FuturaPT-Bold.eot?#iefix') format('embedded-opentype'),
    url('/modules/fonts/futura-pt/FuturaPT-Bold.woff') format('woff'),
    url('/modules/fonts/futura-pt/FuturaPT-Bold.ttf') format('truetype');
    font-weight: bold;
    font-style: normal;
}
/*
